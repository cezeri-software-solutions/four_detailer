...
const _successSeedColor = Color(0xFF29822D);
const _warningSeedColor = Color(0xFFED9923);
const _decorativeSeedColor = Color(0xFFE4DC93);
const _decorative2SeedColor = Color(0xFFE88CDA);
