...
void showTitleRequiredDialogWolt({required BuildContext context}) {
  WoltModalSheet.show<void>(
    context: context,
    pageListBuilder: (context) {
      return [
        WoltModalSheetPage(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [Text(context.l10n.title), Icon(Icons.close, color: context.colorScheme.error)],
                ),
              ],
            ),
          ),
          stickyActionBar: Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.end,
              children: [FilledButton(onPressed: context.pop, child: Text(context.l10n.ok))],
            ),
          ),
        ),
      ];
