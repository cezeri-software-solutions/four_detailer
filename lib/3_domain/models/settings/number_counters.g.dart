...
NumberCounters _$NumberCountersFromJson(Map<String, dynamic> json) =>
    NumberCounters(
      ...
      nextIncomingInvoiceNumber:
          (json['next_incoming_invoice_number'] as num).toInt(),
      nextBranchNumber: (json['next_branch_number'] as num).toInt(),
      nextCustomerNumber: (json['next_customer_number'] as num).toInt(),
    );

Map<String, dynamic> _$NumberCountersToJson(NumberCounters instance) =>
    <String, dynamic>{
      'id': instance.id,
